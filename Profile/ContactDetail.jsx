...
export class IndividualDetailSection extends Component {
    constructor(props) {
        ...
        //this.updateEachProperty = this.updateEachProperty.bind(this)
    }
    ...
    //         (item) => {
    //             this.props.controlFunc(item, data[item])
    //         }
    //     )
    // }
    ...
    saveContact() {
        ...
        //this.updateEachProperty()

        this.props.controlFunc(data)


        // this.props.controlFunc('firstName', data.firstName)
        // this.props.controlFunc('lastName', data.lastName)
        // this.props.controlFunc('email', data.email)
        // this.props.controlFunc('phone', data.phone)
        ...
        //     key => {this.props.controlFunc(key, data[key])}
        // )
